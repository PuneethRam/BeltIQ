...
from .models import BeltAnalysis
...
def prediction(request):
    ...
    if request.method == 'POST':
      ...
      while True:
        ...
        elif feed_values[2]>100:
          alert="Alert"
          reason="High Temperature"
        elif feed_values[2]<10:
          alert="Alert"
          reason="Low Temperature" 
        if feed_values[3]>10 or feed_values[2]>100 or feed_values[2]<10: 
          break
        time.sleep(5)
      

      analysis_result = BeltAnalysis(
            alert_status=alert,
            location="Segment1",
            reason=reason,
      ...
      last_uploaded_text= BeltAnalysis.objects.latest('uploaded_at')
